...
<body class="animsition">
		...
		<div class="container-menu-desktop">
			<div class="topbar">
				<div class="content-topbar container h-100">
					...
					<div class="right-topbar">
						<a href="https://www.youtube.com/@arcstudio5023">
			...
			<div class="wrap-header-mobile">
				...
				<div class="logo-mobile">
					<a href="index"><img src="images/icons/logo-01.svg" alt="IMG-LOGO"></a>
				</div>
			...
			<div class="wrap-logo container">
				<!-- Logo desktop -->		
				<div class="logo">
					<a href="index.html"><img src="images/icons/logo-01.svg" alt="LOGO"></a>
				</div>	

				<!-- Banner -->
				<div class="banner-header">
					<a href="index.html"><img src="images/banner-01.svg" alt="IMG"></a>
				</div>
			</div>	
				...
				<div class="main-nav">
					...
					<nav class="menu-desktop">
						<a class="logo-stick" href="index.html">
							<img src="images/icons/logo-01.svg" alt="LOGO">
						</a>
							...
							<li class="mega-menu-item">
								...
								<div class="sub-mega-menu">
									<div class="nav flex-column nav-pills" role="tablist">
										...
										<a class="nav-link" data-toggle="pill" href="#news-1" role="tab">Entertainment</a>
										<a class="nav-link" data-toggle="pill" href="#news-2" role="tab">Business</a>
										<a class="nav-link" data-toggle="pill" href="#news-3" role="tab">Drama</a>
										...
										<div class="tab-pane show active" id="news-0" role="tabpanel">
											<div class="row">
												<div class="col-3">
													...
													<div>
														<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
															<img src="images/post-05.svg" alt="IMG">
														</a>

														<div class="p-t-10">
															<h5 class="p-b-5">
																<a href="blog-detail-01.html" class="f1-s-5 cl3 hov-cl10 trans-03">
																	Lalisa เตรียมปล่อยเพลงใหม่! 
																</a>
															</h5>
												...
												<div class="col-3">
													...
													<div>
														<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
															<img src="images/post-14.svg" alt="IMG">
														</a>
												...
												<div class="col-3">
													...
													<div>
														<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
															<img src="images/post-36.svg" alt="IMG">
														</a>

														<div class="p-t-10">
															<h5 class="p-b-5">
																<a href="blog-detail-01.html" class="f1-s-5 cl3 hov-cl10 trans-03">
																	Apple Vision Pro ลดจำนวนการผลิต
																</a>
															</h5>
							...
							<li class="mega-menu-item">
								...
								<div class="sub-mega-menu">
									<div class="nav flex-column nav-pills" role="tablist">
										...
										<a class="nav-link" data-toggle="pill" href="#business-2" role="tab">Finance</a>
									</div>
		...
		<div class="container">
			<div class="row m-rl--1">
				<div class="col-md-6 p-rl-1 p-b-2">
					<div class="bg-img1 size-a-3 how1 pos-relative" style="background-image: url(images/post-01.svg);">
						...
						<div class="flex-col-e-s s-full p-rl-25 p-tb-20">
							...
							<h3 class="how1-child2 m-t-14 m-b-10">
								<a href="blog-detail-01.html" class="how-txt1 size-a-6 f1-l-1 cl0 hov-cl10 trans-03">
									Chip war การเเข่งขันระหว่างจีนกับสหรัฐอเมริกา
								</a>
							</h3>
				...
				<div class="col-md-6 p-rl-1">
					<div class="row m-rl--1">
						<div class="col-12 p-rl-1 p-b-2">
							<div class="bg-img1 size-a-4 how1 pos-relative" style="background-image: url(images/post-02.svg);">
								<a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
								...
								<div class="flex-col-e-s s-full p-rl-25 p-tb-24">
									...
									<h3 class="how1-child2 m-t-14">
										<a href="blog-detail-01.html" class="how-txt1 size-a-7 f1-l-2 cl0 hov-cl10 trans-03">
											LISA คัมแบ็ค! เตรียมปล่อยซิงเกิลใหม่ "ROCKSTAR"
										</a>
									</h3>
									<span class="how1-child2">
										<span class="f1-s-4 cl11">
						...
						<div class="col-sm-6 p-rl-1 p-b-2">
							<div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url(images/post-03.svg);">
								<a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
						...
						<div class="tab01 p-b-20">
							<div class="tab01-head how2 how2-cl1 bocl12 flex-s-c m-r-10 m-r-0-sr991">
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#tab1-2" role="tab">Finance</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#tab1-3" role="tab">Economics</a>
									</li>
								...
								<!--  -->
								<a href="category-news.html" class="tab01-link f1-s-1 cl9 hov-cl10 trans-03">
									View all
						...
						<div class="tab01 p-b-20">
							<div class="tab01-head how2 how2-cl2 bocl12 flex-s-c m-r-10 m-r-0-sr991">
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#tab2-2" role="tab">Music</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#tab2-3" role="tab">Drama</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#tab2-4" role="tab">Movies</a>
									</li>
						...
						<div class="tab01 p-b-20">
							<div class="tab01-head how2 how2-cl3 bocl12 flex-s-c m-r-10 m-r-0-sr991">
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#tab3-2" role="tab">Thai</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#tab3-3" role="tab">U.S.A.</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#tab3-4" role="tab">China</a>
									</li>
				...
				<div class="col-md-10 col-lg-4">
					<div class="p-l-10 p-rl-0-sr991 p-b-20">
						...
						<div class="flex-c-s p-t-8">
							<a href="#">
								<img class="max-w-full" src="images/banner-02.svg" alt="IMG">
							</a>
						</div>
							...
							<ul class="p-t-35">
								<li class="flex-wr-sb-c p-b-20">
									...
									<div class="size-w-3 flex-wr-sb-c">
										...
										<a href="https://www.youtube.com/@arcstudio5023" class="f1-s-9 text-uppercase cl3 hov-cl10 trans-03">
											Like
										</a>
									</div>
								</li>
	...
	<div class="container">
		<div class="flex-c-c">
			<a href="#">
				<img class="max-w-full" src="images/banner-01.svg" alt="IMG">
			</a>
		</div>
	</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6 col-lg-4 p-b-20">
						<div class="size-h-3 flex-s-c">
								<a href="index.html">
									<img class="max-s-full" src="images/icons/logo-01.svg" alt="LOGO">
								</a>
							</div>
	
							<div>
								<p class="f1-s-1 cl11 p-b-16">
									Our website was made for ARC Group at first
								</p>
								...
								<p class="f1-s-1 cl11 p-b-16">
									Call us on (+66) 096 716 6879
								</p>
	
								<div class="p-t-15">
									<a href="https://www.youtube.com/@arcstudio5023" class="fs-18 cl11 hov-cl10 trans-03 m-r-8">
										<span class="fab fa-facebook-f"></span>
									</a>
 ...
 &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved  <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://www.youtube.com/@arcstudio5023" target="_blank">ARCStudios</a>
